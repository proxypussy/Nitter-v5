    ...
    <div style={{ maxWidth: 600, margin: '0 auto', padding: 20, fontFamily: 'sans-serif' }}>
      ...
      <form onSubmit={handlePost} style={{ marginBottom: 30, background: '#f5f5f5', padding: 15, borderRadius: 8 }}>
        <textarea
          ...
          style={{ width: '100%', height: 80, borderRadius: 4, padding: 8 }}
        />
        <div style={{ marginTop: 10, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <label style={{ color: '#e91e63', fontWeight: 'bold', cursor: 'pointer' }}>
            <input
              type="checkbox"
              checked={isSpoiler}
            ...
            <div key={post.id} style={{ borderBottom: '1px solid #ddd', padding: '15px 0' }}>
              ...
              {post.is_spoiler && (
                <button
                  ...
                  style={{ marginTop: 8, fontSize: '0.8rem', background: '#e91e63', color: '#fff', border: 'none', borderRadius: 4, padding: '4px 8px', cursor: 'pointer' }}
                >
